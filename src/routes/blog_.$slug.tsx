            ...
            <div className="mt-12 grid gap-4 border-t border-border/60 pt-8 sm:grid-cols-2">
              {prev ? (
                <Link
                  ...
                  className="group flex flex-col rounded-2xl bg-card p-5 shadow-soft transition hover:shadow-card"
                >
              ...
              {next && (
                <Link
                  ...
                  className="group flex flex-col items-end rounded-2xl bg-card p-5 text-right shadow-soft transition hover:shadow-card"
                >
                  <span className="inline-flex items-center gap-1 text-xs font-semibold text-primary">
